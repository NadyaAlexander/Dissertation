...
g_plot_line<-ggplot()+geom_line(data=GplotData_line,aes(x=Gsd,y=meanErr))+ labs(
              y="Flow Volume Error (AF)",
              x="Gate Position (G) Standard Deviation (Ft)")+
              theme_bw()

ggsave(filename ="gPlot_line",
       plot=g_plot_line,
       path="/Users/TheVault/Desktop/GateWork/Dissertation/PM_Edits/outputs/sensitivity_analysis_pm/",
      device="png",
      width=6.5,
...
H_plot_line<-ggplot()+geom_line(data=HplotData_line,aes(x=Hsd,y=meanErr),alpha=.5)+ labs(
              y="Flow Volume Error (AF)",
              x="Upstream Level (H) Standard Deviation (Ft)")+
              theme_bw()

ggsave(filename ="hPlot_line",
       plot=H_plot_line,
       path="/Users/TheVault/Desktop/GateWork/Dissertation/PM_Edits/outputs/sensitivity_analysis_pm/",
      device="png",
      width=6.5,
...
T_plot_line<-ggplot()+geom_line(data=TplotData_line,aes(x=Tsd,y=meanErr))+ labs(
              y="Flow Volume Error (AF)",
              x="Time (T) Standard Deviation (Hour)")+
              theme_bw()

ggsave(filename ="tPlot_line",
       plot=T_plot_line,
       path="/Users/TheVault/Desktop/GateWork/Dissertation/PM_Edits/outputs/sensitivity_analysis_pm/",
      device="png",
      width=6.5,
